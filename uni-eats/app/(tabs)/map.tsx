...
const MapPin = ({ number, top, left, onPress }: { number: number, top: DimensionValue, left: DimensionValue, onPress: () => void }) => (
        ...
        <View>
            ...
            <View style={styles.mapCard}>
                <View style={styles.mapImageContainer}>
                    ...
                    <MapPin number={1} top="30%" left="40%" onPress={() => handlePinPress(0)} />
                    <MapPin number={2} top="50%" left="20%" onPress={() => handlePinPress(1)} />
                    <MapPin number={3} top="60%" left="70%" onPress={() => handlePinPress(2)} />
